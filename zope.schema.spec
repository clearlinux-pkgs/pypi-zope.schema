...
cd %{_builddir}/zope.schema-4.9.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582847629
...
cp %{_builddir}/zope.schema-4.9.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/zope.schema/a0b53f43aab58b46bf79ba756c50771c605ab4c5
